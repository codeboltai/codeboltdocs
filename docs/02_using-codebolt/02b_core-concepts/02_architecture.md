...
|---|---|---|
| Tool runners, MCP wiring, and service routing | [Tools and MCP](../05a_tools-and-mcp/01_overview.md), [MCP servers](../04b_agent-extensions/06_installing-mcp-servers.md) | Which tools to call and how to interpret results |
| Project context, history, memory, and event state | [Memory](../07_memory/01_overview.md), [Context Assembly](../07_memory/03_context-assembly.md) | What context to request, compress, or ignore |
| Verification, guardrails, evals, and approval checks | [Guardrails](../05b_guardrails-and-settings/01_guardrails.md), [Eval and Optimization](../05e_eval-and-optimization/01_overview.md) | When to continue, retry, stop, or ask for help |
| Local and remote execution environments | [Local Scaling](./07_local-scaling.md), [Cloud Scaling](./08_cloud-scaling.md), [Environment Providers](../08a_environments/03_environment-providers.md) | Where the work should run for a task |
| Review and merge workflows | [Review and Merge](../07_multi-agent-usage/04_review-and-merge.md), [Git and Shadow Git](../08_integrations/03_git-and-shadow-git.md) | What change to propose and what policy to follow |
| Plugin, client, and custom app surfaces | [Extend To Your Process](./06_extend-to-your-process.md), [Building Plugins](../07z_plugins/04_building-plugins.md), [Custom Agentic Applications](../08da_custom-agentic-application/01_overview.md) | How users and external systems interact with the agent |
