...
sidebar_position: 0
title: Get Started
description: Install the Codebolt TUI, authenticate, configure a provider, and run your first agent task without leaving the terminal.
---

# TUI — Get Started

Launch the Codebolt terminal UI, get it configured, and run your first agent task without leaving the terminal. The TUI is bundled with the CLI and gives you a keyboard-driven full-screen interface inside your terminal.

---

## 1. Install the TUI

The TUI (Terminal UI) is bundled with the CLI. The CLI requires **Node.js 18+**.
...
> If you already have the desktop app installed, the TUI is already there — no separate install needed.
...
The full-screen TUI opens with panels for chat, file tree, diff view, and terminal output. It connects to the local server and attaches to the current directory.
