...
- desktop or CLI interface surfaces for installing and managing MCP servers at runtime
...
Use the desktop or CLI interface product surfaces for runtime MCP installation and management.
