...
sidebar_position: 0
title: Overview
description: Desktop panels for managing agents, work queues, plans, swarms, orchestrators, and execution environments.
---

# Agent Management Features

Agent Management Features are the desktop panels used to track agent work, route tasks, inspect active runs, and manage execution contexts.
...
| [Tasks](./03_tasks.md) | Track task state, task details, and task execution context. |
| [Action Plans](./04_action-plans.md) | Create and inspect executable plans with tasks, groups, flow views, and timelines. |
| [Requirement Plan](./05_requirement-plan.md) | Combine specs, UI flows, action plans, and notes into one planning document. |
