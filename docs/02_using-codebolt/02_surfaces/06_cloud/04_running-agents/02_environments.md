...
These are **machines** you connected to Cloud with the runner daemon (`codebolt runner daemon start`). The runner node is the host; the runtimes it hosts appear nested underneath it. See [Runner Nodes](./05_runner-nodes.md).
...
5. Pick a **sync mode** — see [Syncing Changes](./03_syncing-changes.md).
...
- [Syncing Changes](./03_syncing-changes.md) — how changes in an environment reach your repo
- [Runner Nodes](./05_runner-nodes.md) — connecting a machine
