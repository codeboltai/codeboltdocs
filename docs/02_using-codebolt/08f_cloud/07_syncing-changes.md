...
3. **Sync back** — changes are returned via one of:
   ...
   - A **Review Merge Request (RMR)** that creates an upstream GitHub PR — see [Review Merge Requests](./09_review-merge-requests.md).
...
- [Cloud Environments](./06_environments.md) — parent/child environments and the tree
- [Review Merge Requests](./09_review-merge-requests.md) — the Git sync review workflow
