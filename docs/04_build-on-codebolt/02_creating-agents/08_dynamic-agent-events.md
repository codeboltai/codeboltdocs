---
sidebar_position: 8
title: Dynamic Agent Events
description: Dynamic agent events let agents publish named runtime events that hooks, plugins, and context assembly rules can react to.
---
