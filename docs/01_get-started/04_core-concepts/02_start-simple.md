...
Use the [desktop app](../../02_using-codebolt/02_surfaces/02_desktop-app/00_get-started.md) when you want chat, files, panels, settings, and project state in one interface. Use the [CLI](../../02_using-codebolt/02_surfaces/04_cli/01_cli-interface/00_get-started.md) when you want terminal-first agent runs, scripts, logs, command mode, or automation.
