# Self Hosted Agent Infrastructure Overview

> Use Codebolt as self-hosted agent infrastructure across local machines, company environments, sandboxes, cloud runtimes, and external channels.
