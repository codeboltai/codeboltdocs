...
> The Chat tab is the primary working surface in gotui, combining free-form prompting, structured runtime messages, command-style input, and overlay controls.
