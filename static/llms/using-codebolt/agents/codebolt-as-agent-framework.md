...
> Codebolt isn't only an app you chat with — it is also an agent framework. Define agents in code with @codebolt/agent and call them from any application using @codebolt/client-sdk.
